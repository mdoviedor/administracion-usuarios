...
class EgresadoEvento
{
     ...
     * Set evento
     *
     * @param \Aseduis\UserBundle\Entity\Evento $evento
     * @return EgresadoEvento
     */
    public function setEvento(\Aseduis\UserBundle\Entity\Evento $evento = null)
    {
        $this->evento = $evento;
     ...
     * Get evento
     *
     * @return \Aseduis\UserBundle\Entity\Evento 
     */
     ...
     *
     * @param \Aseduis\UserBundle\Entity\Conocimientoevento $conocimientoevento
     * @return EgresadoEvento
     */
    public function setConocimientoevento(\Aseduis\UserBundle\Entity\Conocimientoevento $conocimientoevento = null)
    {
     ...
     *
     * @return \Aseduis\UserBundle\Entity\Conocimientoevento 
     */
